...
export function renderVolumeControl(ui, store, audio, muteButton, applyAudioSettings) {
  ...
  applyAudioSettings(audio, ui.volumeInput, roomMode ? roomAudio.volume : state.localVolume, roomMode ? roomAudio.muted : state.localMuted, muteButton);
}
...
export function applyAudioSettings(audio, volumeInput, value, muted, muteButton) {
